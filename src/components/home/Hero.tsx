        ...
        <FadeIn direction="right" delay={0.2} className="w-full">
          <div className="relative">
            <Image
              ...
              alt="MacBook displaying Shopify dashboard in a modern workspace"
              width={1376}
              height={768}
              className="w-full h-auto rounded-2xl"
              priority
            />
            <div className="absolute bottom-4 left-4 right-4 bg-surface-card/90 backdrop-blur-xl shadow-ambient rounded-2xl p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-primary/[0.06] rounded-lg p-2">
                  <p className="text-[9px] uppercase tracking-wider text-on-surface-variant mb-0.5">ROAS</p>
                  <p className="text-base font-semibold text-primary">4.2x</p>
                </div>
                <div className="bg-surface-low rounded-lg p-2">
                  <p className="text-[9px] uppercase tracking-wider text-on-surface-variant mb-0.5">CAC</p>
                  <p className="text-base font-semibold text-on-surface">$18.40</p>
                </div>
                <div className="bg-surface-low rounded-lg p-2">
                  <p className="text-[9px] uppercase tracking-wider text-on-surface-variant mb-0.5">Spend</p>
                  <p className="text-base font-semibold text-on-surface">$12.4K</p>
                </div>
              </div>
            </div>
          </div>
