  ...
  return (
    <Section className="min-h-[90vh] flex items-center !py-24 lg:!py-32">
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        {/* Right: Dashboard mockup over hero image */}
        <FadeIn direction="right" delay={0.2} className="w-full">
          <div className="relative">
            {/* Background decorative image */}
            <Image
              src="/images/hero-bg.png"
              alt="Abstract flowing surfaces with blue beam"
              width={1200}
              height={675}
            ...
            <div className="relative bg-surface-card shadow-ambient rounded-2xl p-6">
              {/* Header */}
